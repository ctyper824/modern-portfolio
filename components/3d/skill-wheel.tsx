...
const skillsData = [
  {
    ...
    color: "#ED8B00",
    position: [3, 0, 0],
    description: "Enterprise application development and Click Software customization",
  },
  {
    name: "JavaScript",
    category: "Languages",
    ...
    color: "#F7DF1E",
    position: [2.1, 2.1, 0],
    description: "Frontend and backend scripting for integrations and web applications",
  },
  {
    name: "ClickSchedule",
    category: "Click Software",
    level: 96,
    color: "#00B4D8",
    position: [0, 3, 0],
    description: "Custom scheduling solutions that reduce conflicts and improve workforce planning",
  },
  {
    name: "ClickMobile",
    category: "Click Software",
    ...
    color: "#0077B6",
    position: [-2.1, 2.1, 0],
    description: "Mobile field service apps with real-time data access for technicians",
  },
  {
    name: "ClickOptimize",
    category: "Click Software",
    ...
    color: "#023E8A",
    position: [-3, 0, 0],
    description: "Rules, scripts, and optimization for dispatch and resource utilization",
  },
  {
    name: "SQL Server",
    category: "Databases",
    ...
    color: "#CC2927",
    position: [-2.1, -2.1, 0],
    description: "Database design, queries, and real-time integrations for field service data",
  },
  {
    name: "REST APIs",
    ...
    color: "#61DAFB",
    position: [0, -3, 0],
    description: "Enterprise ERP and CRM integrations with seamless data exchange",
  },
  {
    name: "React.js",
    category: "Frameworks",
    ...
    color: "#61DAFB",
    position: [2.1, -2.1, 0],
    description: "Modern frontend development with React and related JavaScript frameworks",
  },
]
